...
/////////////////////////
//////////////////////////// report //////////////////////////////////
// brute force를 이용할 경우 각각의 정수가 들어갈 때, 안 들어갈 때 = 2의 n승
// 최대, 2의 20승 = 10의 6승이므로 brute force를 이용할 수 있다
...
// 즉, 00000 ~ 11111을 다 해보면 되는데, 이 때 00000~11111를 이진수로 생각할 수 있다
// => 횟수를 이진수로 만들고, 이진수를 flag로 생각하면 됨
